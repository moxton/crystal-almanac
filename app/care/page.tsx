...
function getCareNotes(crystal: Crystal): string {
  ...
  const notes: Record<string, string> = {
    ...
    "arsenopyrite": "TOXIC: Contains arsenic. Produces garlic odor when struck. Wash hands after handling. Display only. Never heat or grind.",
    "chrysotile": "TOXIC: Asbestos mineral. Never cut, grind, or disturb fibers. Handle sealed specimens only. Wash hands thoroughly. Keep away from children.",
    "proustite": "TOXIC: Contains arsenic. Darkens permanently in light. Store in complete darkness. Wash hands after handling.",
    "anglesite": "Contains lead. Wash hands after handling. Very soft and fragile. Display only.",
    "satin-spar": "Dissolves in water. Store dry. Clean with dry cloth only. Extremely soft (Mohs 2).",
